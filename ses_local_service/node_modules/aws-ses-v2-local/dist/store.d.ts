...
export declare const getTemplate: (key: string) => Template | undefined;
export declare const setTemplate: (key: string, value: Template) => Map<string, Template>;
export declare const deleteTemplate: (key: string) => boolean;
export declare const clearStore: () => void;
export declare const getStoreReadonly: () => Readonly<Store>;
export declare const convertToMailOptions: (email: Email) => MailOptions;
